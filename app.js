...
const IFRAME_TABS = { dxf: "frame-dxf", barcut: "frame-barcut", paint: "frame-paint", metali: "frame-metali", nesting: "frame-nesting" };
...
function activateTab(tabName) {
  ...
  ["calc", "data", "dxf", "barcut", "paint", "metali", "nesting"].forEach((t) => {
